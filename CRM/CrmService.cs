...
namespace Student8.CRM
{
    ...
    public class CrmService
    {
        ...
        public CrmService()
        {
            ...
            var credentials = new System.Net.NetworkCredential(Configuration["crmcreds:username"], Configuration["crmcreds:password"]);
            conn = new CrmServiceClient(credentials,
               "stu16-08.crm.eperformanceinc.com",
               "443",
               "stu16-08", useUniqueInstance: true, useSsl: true);
